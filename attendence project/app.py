...
def login():
            ...
            if row == None:
                ...
                def manage_employee():
                    try:
                        ...
                        background_pic.pack()
                        first.title("Data Management")
                        print("Hi Tharun")
                        face = Label(first, text = "Management of Student/Staff" , bg = "green" , fg = "yellow", padx = 15, pady = 15, font = ("Times New Roman", 20, "bold") ,borderwidth = 5, relief = RIDGE).place(x = 500, y = 10)
                    ...
                    ################################################## Employee Management form ###############################
                        ...
                        titles = Label(f2, text = "Manage Data" ,bg = "gray", font = ("Italic", 20, "bold")).place(x = 90, y = 30)
                        id = Label(f2, text = "Register ID", bg = "gray", font = ("italic",13, "bold")).place(x = 35, y = 100 )
                    ...
                    ################################################################################## Table frame
                        ...
                        table1.heading("eid", text ="Register ID")
                ...
                def train(): 
                    try:
                        ...
                        img3= PhotoImage(file = "Photos/backgro2.png", master = second)
    ...
    ######################################### Function to recognize the face
                ...
                bg_image = PhotoImage(file = "Photos/backgro2.png", master = attendance)
                ...
                B1 = Button(attendance, image = photo1, text = "Data Management",font = ("Times New Roman" , 15), fg = "green", height =230, width = 265, command = manage_employee, compound = BOTTOM )
                ...
                B4.place(x =1120, y = 400)
                photo5 = PhotoImage(file = "Photos/reports.png" ,  master = attendance)
                ...
                photo7 = PhotoImage(file = "Photos/password12.png", master = attendance)
...
bg_icon = PhotoImage(file = "Photos/backgro.png", master = face)
background_image = Label(face, image = bg_icon)
background_image.pack()

title = Label(face, text = "Admin Login Page" , font = ("times new roman", 30, "bold"), bg = "#8FBC8F", fg = "yellow", bd = 7, relief = GROOVE) 
title.place(x = 0, y = 0, relwidth = 1)

clock = Label(face , font = ("times",20,"bold"), bg = "#CAE1FF", relief = GROOVE)
...
submit_btn = Button(login_frame, text = "Log In",width = 10, activebackground = "#BBFFFF", activeforeground = "white", command = login , font = ("times new roman", 20, "bold"),relief = GROOVE, bg = "#BBFFFF").grid(row = 3, column = 1, pady =25, padx = 25) 
face.mainloop()                     