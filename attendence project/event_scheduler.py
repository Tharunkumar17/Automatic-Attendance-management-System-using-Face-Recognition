...
def send_mail():
    ...
    server.starttls()
    server.login('sundarrrr12@gmail.com','wimqjemwombxcuau')
    for email in absent_staff_emails:
        server.sendmail('sundarrrr12@gmail.com',
                    email,
                    'You are absent')
    ...
    msg['From'] = 'sundarrrr12@gmail.com'
    ...
    with smtplib.SMTP_SSL('smtp.gmail.com',465) as smtp:
        smtp.login('sundarrrr12@gmail.com','wimqjemwombxcuau')
...
sched.add_job(send_mail,'cron',day_of_week='mon-sun', hour=17, minute=55)
sched.start()
